...
from torch_geometric.nn import GATConv, GCNConv, to_hetero
...
def main():
    ...
    parser.add_argument('--dataset_path', help = '''Path to the saved hierarchical graph''', 
                        default = './med_exp/heteromed/HeteroMedGraph.pkl', type = str)
    ...
    parser.add_argument('--results_path', help = '''Path to save the results''',
                        default = './med_exp/heteromed/results', type = str)
    parser.add_argument('--model_save_path', help = '''Path to save the trained model''',
                        default = './med_exp/heteromed/results/hetero_gnn_model_neg_10.pt', type = str)
